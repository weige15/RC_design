    ...
    def paintEvent(self, event):
        ...
        if self.drawornot =='yes' :
            ...
            self.qpainter.drawRoundedRect(
                int(self.str_start), int(self.str_start), int(self.str_height), int(self.str_width), 
                self.arcd / 2, self.arcd / 2
            )

            # self.qpainter.drawArc(self.str_start,self.str_start,self.arcd,self.arcd,45*16,180*16)
            self.qpainter.drawArc(
                int(self.str_start), int(self.str_start), int(self.arcd), int(self.arcd),
                45 * 16, 180 * 16
            )
            ...
            self.qpainter.drawLine(
                int(self.cuvre_start[0]), int(self.cuvre_start[1]),
            ...
            self.qpainter.drawLine(
                int(self.cuvre_start[0]-self.arcd/2**0.5),int(self.cuvre_start[1]+self.arcd/2**0.5),
